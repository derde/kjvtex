...
\newcommand{\sharedverse}[2]{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}\hspace{\myversehspace}}\def\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
