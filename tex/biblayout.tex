...
\TPGrid[0mm,10mm]{60}{61}% defines tiny boxes down right hand margin for book name - see textblock below.  For 66 books, we have 61 markers
...
\begin{textblock}{1}(59,#1)%
%\rule[0em]{1em}{1ex}%
\hfuzz=72pt
\raisebox{0pt}[0pt]{\color{lightgray}\rule[0em]{2em}{1.0em}}%
\end{textblock}
}
...
\raisebox{0.6\baselineskip}[0.5\baselineskip][0pt]{%
    %\textbf{\mybooktitlefont\mybooktitlesettings #1}}%
    {\mybooktitlefont\mybooktitlesettings #1}}%
...
%\vfill
\begin{center}%
\textsc{\mybooktitlesettings\ENpretitle}%HOLY BIBLE
\par
\bookheadingstrut{3\baselineskip}
\raisebox{0.6\baselineskip}[0.5\baselineskip][0pt]{{\mybooktitlefont{\mybooktitlesettings\ENtitle}}}% King James Bible
\par
\textsc{\mybooktitlesettings\ENsubtitle}% kjvtex compactt
