...
\fancyhead[OR]{\myheadingfont \textbf{\textemdash\ \leftmark}%}% Top right header
\fancyhead[EL]{\myheadingfont \textbf{\textemdash\ \rightmark}\biblthumbmark{\mythumbindex}}% Top left header - leading dash is to discourage accidental reading of the heading
...
\newfontfamily\mylatexfont[FakeStretch=1.3]{\myfontname} % For saying "Latex" without looking ugly
...
\renewcommand{\verse}[2]{\raisebox{2pt}[0pt]{\mysuperscriptfont\textbf{#1}\hspace{0.1em}}\gdef\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
...
\newcommand{\biblnewreference}[2]{\markboth{#1}{#1}\gdef\mythumbindex{#2}}%
\newcommand{\biblendreference}[2]{\markboth{#1}{#1}\gdef\mythumbindex{#2}}%
\newcommand{\biblbookheading}[1]{
...
\newcommand{\biblnewbook}[2]{\def\mybookshort{#2}\gdef\mythumbindex{#2}}%
%
...
\par
% test {\myhebrewfont א ב ג ד ה ו ז ח ט י כ ל מ נ ס ע פ צ ק ר ש ת }
