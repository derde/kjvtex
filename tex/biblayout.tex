...
\renewcommand{\verse}[2]{\mybeforeverse\raisebox{\myverseraise}[0pt]{\mysuperscriptfont\textbf{#1}\hspace{0.1em}}\def\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
...
{\uselengthunit{mm}Paper size \rndprintlength{\pdfpagewidth} $ \times $ \rndprintlength{\pdfpageheight}}\myshowpageinfo
\par
Font \makeatletter \f@family \makeatother\ \the\fontdimen6\font\the\font\ scaled \myfontstretch/1,
...
\immediate\write\mypages{\unexpanded{\gdef\myshowpageinfo}{, \thepage\ pages}}%
\biblenddocument
%%\bigskip%%\ldots
\end{document}
