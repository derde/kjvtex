...
\newfontfamily\mylatexfont[FakeStretch=1.2]{\myfontname}% For saying "Latex" without looking ugly
...
\renewcommand{\verse}[2]{\mybeforeverse\raisebox{\myverseraise}[0pt]{\mysuperscriptfont\textbf{#1}\hspace{0.8pt}}\def\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
