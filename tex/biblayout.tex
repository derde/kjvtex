...
\newfontfamily\mysuperscriptfont[\myboldness FakeStretch=\myfontstretch,Scale=\myversescale]{\mysansfont}
...
\def\hebrewleader{}%
\newcommand{\sharedverse}[2]{\raisebox{\myverseraise}[0pt]{\mysuperscriptfont\textbf{#1}\hspace{0.8pt}}\def\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
\newcommand{\versei}[2]{\mypreversei\hebrewleader\def\hebrewleader{}}%3 points up, count height as 0 points, kern at end
\newcommand{\verseii}[2]{\mypreverseii\hebrewleader\sharedverse{#1}{#2}\def\hebrewleader{}}%3 points up, count height as 0 points, kern at end
\renewcommand{\verse}[2]{\mypreverse\hebrewleader\sharedverse{#1}{#2}\def\hebrewleader{}}%3 points up, count height as 0 points, kern at end
...
\myshowpageinfo
\ifdefined\paperwidth{\uselengthunit{mm}\rndprintlength{\paperwidth}$\times$\rndprintlength{\paperheight}}, \fi%
%\newlength\C
%\setlength\C{1pt * \ratio{\paperheight}{\baselineskip}}
%lines=\uselengthunit{pt}\rndprintlength{\C},
}\myformattinginfoi
\par
Font%
...
\else%
    \makeatletter\f@family \makeatother\ \the\fontdimen6\font\the\font, %
\fi
aspect \myfontstretch:1,
line spacing \the\baselineskip}
\myformattinginfoii
\def\myformattinginfoiii{\ifdefined\myextradisplay{, \myextradisplay}\fi}\myformattinginfoiii%
\par
