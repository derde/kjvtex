...
\fancypagestyle{sectionheadings}{%
    ...
    \fancyhead[ER]{}% hush
    \fancyhead[OL]{}% hush
    \fancyhead[C]{\mynoautospacing\myheadingfont \textbf{\mycurrentsection}}% hush
...
\newcommand\extramark{}
\fancyhead[OR]{\mynoautospacing\myheadingfont \textbf{\textemdash\ \leftmark\hspace{1em}\null}\biblthumbmarkright{\mythumbindex}\oddbindingmarks}% Top right header
\fancyhead[EL]{\mynoautospacing\myheadingfont \textbf{\textemdash\ \rightmark}\biblthumbmarkleft{\mythumbindex}\evenbindingmarks}% Top left header - leading dash is to discourage accidental reading of the heading
\fancyhead[C]{\mynoautospacing\myheadingfont {\thepage}}% Center footer - bold is less readable
...
% FIXI?
\newcommand{\biblthumbmark}[3]{% 1:horizontal tab, 2: vertical tab, 3: hspace
...
\newcommand{\biblthumbmarkright}[1]{\biblthumbmark{29}{#1}{0.5mm}}%
\newcommand{\biblthumbmarkleft}[1]{\biblthumbmark{0}{#1}{-4mm}}%
...
\newcommand{\biblendchapter}[2]{\gdef\mythumbindex{#2}\ifdefined\myendchapter{\myendchapter}\fi}%
...
\lettrine[lines=2, lraise=0.00, lhang=0.00, findent=\mylettrinefindent, nindent=0pt, loversize=0.0]{\raisebox{\mychapterraise}[0pt]{\textbf{\mychapterfont\mychapterfontextra #1}}}{}%
}%
%debug: \textbf{#1}}%
...
\newcommand{\biblnewbook}[2]{%
    \write\mytoc{%
        \unexpanded{\bibltocpre}\noindent {\mynostretchfont □ ~}#1 \unexpanded{\mydotfill}{\thepage}\unexpanded{\bibltocpost}\par}% The box is defined in the font, we hope
    \gdef\mybookshort{#2}%
    \gdef\mythumbindex{#2}%
}%
