...
\renewcommand{\verse}[2]{\raisebox{2pt}[0pt]{\mysuperscriptfont\textbf{#1}\hspace{0.1em}}\def\mythumbindex{#2}}%3 points up, count height as 0 points, kern at end
%\newcommand{\biblpagetitles}[2]{\lock{#1}{#2}}%
\newcommand{\bibltwocolumn}{\begin{multicols}{2}}%
\newcommand{\biblonecolumn}{\end{multicols}}%
\newcommand{\biblthumbmark}[1]{\begin{textblock}{1}(25,#1)\hfill\rule[0em]{4mm}{4mm}\end{textblock}}
