...
\def\mystretch{0.85}\def\myboldness{FakeBold=1.00,}\def\myboldness{}
\fontspec{\myfontname}
\setmainfont[\myboldness FakeStretch=\mystretch,Scale=1.00]{\myfontname}% 1006 pages +2
\newfontfamily\myheadingfont[\myboldness FakeStretch=\mystretch,Scale=0.80]{\myfontname} % Used for (synthetic) smallcaps
\newfontfamily\myfootnotefont[\myboldness FakeStretch=\mystretch,Scale=0.80]{\myfontname} % Used for (synthetic) smallcaps
...
\newfontfamily\mysuperscriptfont[\myboldness FakeStretch=\mystretch,Scale=0.65]{\mysansfont}
% Line space = 12pt*4 = 48 , Height = 4*8pt*n+4pt*n = 48pt = n*(24+4)pt=48
\newfontfamily\mybooktitlefont[\myboldness FakeStretch=\mystretch,Scale=2.80]{\myfontname}
% Chapter numbers would be a little bigger than two lines in double size, so scale them down a bit:
\newfontfamily\mychapterfont[\myboldness FakeStretch=\mystretch,Scale=0.90]{\mysansfont}
%\usepackage{fontspec}  
...
scaled \mystretch\ / bold \myboldness,
...
\par
No headings; verses continue on same line; justified; psalm titles; epistles postscripts
\par
