...
%
%\fontspec{Charis SIL}
\setmainfont[]{Charis SIL}% 1006 pages +2
...
\newfontfamily\mybooktitlefont[Scale=2.80]{DejaVu Sans Condensed}
...
\def\strutsomelines{\rule[-1.3\baselineskip]{0pt}{4.0\baselineskip}}%
...
\begin{center}\textbf{\mybooktitlefont{\strutsomelines #1}}\end{center}%
%\par%
\bibltwocolumn}%
...
\vfill
\par
Printed in \makeatletter \f@family \makeatother
{} at \the\fontdimen6\font\the\font
\par
Source repository: https://github.com/derde/kjvtex
\par
Source text md5sum: 6e4d92f05ea149b78a74d4c92ed78355
\par
