...
\documentclass[9pt,twoside,openany,a4paper]{book}
...
\usepackage[left=1.0cm,top=1.0cm,right=1.0cm,bottom=0.9cm,bindingoffset=0.1cm,headheight=5mm]{geometry}%
\geometry{papersize={130mm,220mm}}%
...
\vfill
\par
Typesetting by \LaTeX{} in \makeatletter \f@family \makeatother
