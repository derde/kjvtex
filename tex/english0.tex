...
\usepackage[left=1.5cm,top=1.5cm,right=1.0cm,bottom=1.0cm,bindingoffset=0.5cm,headheight=5mm]{geometry}%
...
\newfontfamily\mybooktitlefont[Scale=3.29]{DejaVu Sans Condensed}
...
\newcommand{\biblbookheading}[1]{\needspace{7\baselineskip}\thispagestyle{nopagenumber}\begin{center}%
\textbf{\mybooktitlefont{#1}}\end{center}\bibltwocolumn\par\vspace{\baselineskip}}%
...
\newcommand{\markieset}{}%
\newcommand{\biblnewchapter}[1]{\renewcommand\markieset{\markboth{#1}{#1}}}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\bibldropcapschapter}[1]{\needspace{1\baselineskip}\lettrine[lines=2, lraise=0.0, lhang=0.05, findent=3pt, nindent=0pt, loversize=0.0]{\textbf{\mychapterfont #1}}{}\markieset}%
...
\begin{center}\textbf{\mybooktitlefont\Huge {King James Bible}}
\par
\vspace{7\baselineskip}%
http://soulwinning.africa/
\par
